With these macros (except Fire up) AvsPThumb can be started from AvsPmod macro menu.
Copy the macros to the AvsPmod macros directory or a subdirectory and adjust the path to AvsPThumb in the macro.
--------------------------------------------------------------------------------------------
